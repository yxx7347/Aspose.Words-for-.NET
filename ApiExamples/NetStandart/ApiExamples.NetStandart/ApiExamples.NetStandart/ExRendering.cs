...
namespace ApiExamples.NetStandart
{
    ...
    public class ExRendering : ApiExampleBase
    {
        ...
        public void RenderToScale()
        {
            ...
            using (SKBitmap image = new SKBitmap(pageSize.Width, pageSize.Height))
            {
                image.SetResolution(myResolution, myResolution);

                using (SKCanvas gr = new SKCanvas(image))
                {
            ...
            doc.Save(MyDir + @"\Artifacts\Rendering.RenderToScale.png");
            //ExEnd
        }
